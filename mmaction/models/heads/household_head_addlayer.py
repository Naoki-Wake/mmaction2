...
class HOUSEHOLDHead_ADDLAYER(BaseHead):
    ...
    def __init__(self,
        ...
        self.fc_cls_household = nn.Linear(self.default_class, self.num_classes)
    ...
    def init_weights(self):
        ...
        normal_init(self.fc_cls_household, std=self.init_std)
    ...
    def forward(self, x, num_segs):
        ...
        x = self.fc_cls(x)
        cls_score = self.fc_cls_household(x)
